...
INSERT INTO signalPulse.html_page (id, date_selector, enabled, link_selector, list_selector, name, title_selector, trust, url, `type`, category_id) VALUES
                                                                                                                                                        ...
                                                                                                                                                        (4, NULL, 1, 'h2.entry-title a', 'article', 'Crowdfund Insider', 'h2.entry-title a', 0.8, 'https://www.crowdfundinsider.com/', 'html_list', 7),
                                                                                                                                                        (5, NULL, 1, 'h4 a', '.news-item', 'The Financial Express (BD) - Fintech', 'h4 a', 0.92, 'https://thefinancialexpress.com.bd/tag/fintech', 'html_list', 7),
                                                                                                                                                        (6, NULL, 1, 'h2.card-title a', '.card-section', 'The Business Standard (BD) - Banking', 'h2.card-title a', 0.9, 'https://www.tbsnews.net/economy/banking', 'html_list', 7),
                                                                                                                                                        (7, NULL, 1, 'h2 a', '.news-item', 'Daily FT (Sri Lanka) - Fintech Sec', 'h2 a', 0.88, 'https://www.ft.lk/fintech/77', 'html_list', 7),
                                                                                                                                                        (8, NULL, 1, '.views-field-title a', '.views-row', 'Central Bank of Sri Lanka - News', '.views-field-title a', 0.96, 'https://www.cbsl.gov.lk/en/news', 'html_list', 6);
